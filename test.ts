...
basic.forever(function () {
    ...
    xiamiBoard.OLEDshowUserText("MD:" + xiamiBoard.motorState(MOTOR.M1, STATE.DIR), 6, 0)
    //xiamiBoard.clear(6, 8, 11)
    xiamiBoard.OLEDshowUserText("MS:" + xiamiBoard.motorState(MOTOR.M1, STATE.SPEED), 6, 5)
